...
Setup a linux vm: ![image](https://github.com/createdform/orbstack-linux-vm-setup-1)

## Step two - SSH/Open a terminal inside the linux vm

Open a terminal or ssh into your new linux vm: ![image](https://github.com/createdform/orbstack-linux-vm-setup-2)
...
![image](login)https://github.com/createdform/caprover-login-page
...
![image](change admin password)https://github.com/createdform/carpover-settings-page

## Congratulations! Your caprover is configured to run on your local machine.

![image](celebration time)https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcGo3cWlweXMxbGV1OTVxOGdvdHBsNm8zNnFsaWsycXI5MmM2MGZuMSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/IwAZ6dvvvaTtdI8SD5/giphy.gif
...
![image](add a domain)https://github.com/createdform/add-a-domain
