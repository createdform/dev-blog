...
![image](login)https://dev-blog-v86e.vercel.app/static/images/caprover-login-page.png
...
![image](change admin password)https://dev-blog-v86e.vercel.app/static/images/carpover-settings-page.png
...
![image](add a domain)https://dev-blog-v86e.vercel.app/static/images/add-a-domain.png
...
<div style={{ width: '260px', maxWidth: '100%' }}>
  <div style={{ height: 0, paddingBottom: '54.23%', position: 'relative' }}>
    <iframe
      ...
      frameBorder='0'
      src='https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcGo3cWlweXMxbGV1OTVxOGdvdHBsNm8zNnFsaWsycXI5MmM2MGZuMSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/IwAZ6dvvvaTtdI8SD5/giphy.gif
'
    ></iframe>
  </div>
  <p>
    <a
      href='https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcGo3cWlweXMxbGV1OTVxOGdvdHBsNm8zNnFsaWsycXI5MmM2MGZuMSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/IwAZ6dvvvaTtdI8SD5/giphy.gif
'
    >
      via Imgflip
    </a>
